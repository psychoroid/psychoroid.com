...
export function CommunityNavbar({ className }: { className?: string }) {
                ...
                <div className="max-w-3xl mx-auto pl-2 pr-4">
                    ...
                    >
                        <div className="flex flex-col space-y-5">
                            ...
                            <Link
                                href="/studio"
                                className="text-sm font-medium text-emerald-500 dark:text-emerald-400 hover:text-emerald-600 dark:hover:text-emerald-600 transition-colors translate-y-[2px]"
                            >
                                {t(currentLanguage, 'navbar.studio')}
                            </Link>
                            <div
