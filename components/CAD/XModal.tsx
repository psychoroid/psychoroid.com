...
// Reuse the format configurations and conversion logic from DownloadModal
...
// Helper function to get model URL (reused from DownloadModal)
...
export function XModal({ isOpen, onClose, product, onDownload }: XModalProps) {
    ...
    // Reuse the download logic from DownloadModal
    const handleDownload = async (format: string) => {
        ...
        try {
            ...
            // Implement the download logic here (reuse from DownloadModal)
