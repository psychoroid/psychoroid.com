...
export function ImagePreview({
    ...
    const totalPages = Math.ceil((imagePaths.length + 1) / imagesPerPage);
        ...
        <>
            ...
            <div className="grid grid-cols-3 gap-4">
                {displayedImages.map((imagePath, index) => (
                    ...
                    >
                        <Image
                            src={`https://peyzpnmmgsxjydvpussg.supabase.co/storage/v1/object/public/product-images/${imagePath}`}
