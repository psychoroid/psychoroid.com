...
export default function WorkspacePage() {
    ...
    return (
        <div className="h-svh bg-background flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide md:h-[calc(100vh-4rem)] pb-32 md:pb-16">
                <div className="container mx-auto p-4 mt-6 md:p-4 md:max-w-[1920px]">
                    {/* Main Content */}
                    <div className="flex flex-col md:flex-row gap-4">
                        {/* Left Panel - Asset Library */}
                        <div className="w-full md:w-[320px] shrink-0 order-1 md:order-1">
                        ...
                        <div className="w-full md:flex-1 order-2 md:order-2 md:min-w-[800px] xl:min-w-[800px]">
                            <div className="h-[50vh] overflow-y-auto scrollbar-hide md:h-[80vh] border border-border bg-card/50">
                                <ProductViewer
                                    key={modelUrl}
                        ...
                        <div className="w-full md:w-[320px] shrink-0 order-3">
                            <div className="h-auto overflow-y-auto scrollbar-hide md:h-[80vh]">
                                <ModelGenerator
